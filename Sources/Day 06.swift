 ...
 */
struct Day06Part1: AdventDayPart {
	var data: String

	static var day: Int = 6
	...
	struct RaceResults: CustomDebugStringConvertible {
		...
		init(_ str: String) {
			...
			let times: [Int] = parse(from: lines[0].verifyAndDrop(prefix: "Time:"), separator: " ")
			let distances: [Int] = parse(from: lines[1].verifyAndDrop(prefix: "Distance:"), separator: " ")
